import type { ApiPreview as ApiPreviewData } from "@/lib/api-preview";
    ...
    <section className="rounded-lg border border-white/10 bg-zinc-950/70 p-5">
      ...
      <div className="mt-5 divide-y divide-white/10 border-y border-white/10">
        {preview.requests.map((request) => (
          <div
            className="grid gap-2 py-3 text-sm md:grid-cols-[120px_88px_1fr_72px] md:items-center"
